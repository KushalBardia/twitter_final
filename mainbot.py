...
while True:
    user = api.get_user('KushalBardia')
    api.update_profile(name=f'Kushal Bardia|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Kushal Bardia|{follower_count(user)} Followers')
